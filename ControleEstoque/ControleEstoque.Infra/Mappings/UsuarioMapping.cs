...
namespace ControleEstoque.Infra.Mappings
{
    public class UsuarioMapping : IEntityTypeConfiguration<Usuario>
    {
        ...
        public void Seed(EntityTypeBuilder<Usuario> builder)
        {
            ...
            var administrador = new Usuario("Fred", "085.435.367-43", "fred@gmail.com", senha, new DateTime(2001, 02, 13), NiveisAcesso.Administrador);
            administrador.SetId(Guid.NewGuid());

            var funcionario1 = new Usuario("Gabriela", "085.657.339-77", "gabriela@gmail.com", senha, new DateTime(2001, 02, 13), NiveisAcesso.UsuarioLoja1);
            funcionario1.SetId(Guid.NewGuid());

            var funcionario2 = new Usuario("Ericka", "085.657.339-77", "ericka@gmail.com", senha, new DateTime(2001, 02, 13), NiveisAcesso.UsuarioLoja2);
